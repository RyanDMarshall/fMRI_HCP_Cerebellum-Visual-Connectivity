...
out_dir_pearson=sprintf('%s/pearson_t',out_dir); 
out_dir_partial=sprintf('%s/partial_t',out_dir); 
...
make_diffMap(bilat_z_list,bilat_p_list,rois,cmat,"union",0.95,out_dir_bilat,"V3A+IPS0+IPS1+IPS2+IPS3","hV4+VO1+VO2+PHC1+PHC2",0)
